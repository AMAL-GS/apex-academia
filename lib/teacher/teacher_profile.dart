...
import 'package:flutter_apex_academia/teacher/Teacher_basic.dart';
import 'package:flutter_apex_academia/teacher/teacher_address.dart';
import 'package:flutter_apex_academia/teacher/teacher_contact.dart';
...
class _Teacher_profileState extends State<Teacher_profile> {
   List support1=["Suggestion","About us"];
  List legal1=["Terms and conditions","Logout"];
  @override
                        ...
                        Row(
                          children: [ 
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap:(){ Navigator.push(context, MaterialPageRoute(builder: (context) =>Teacher_basic(),),);},
                                child: Container(
                        ...
                        ,Text("6282541736")
                          ...
                          children: [ 
                            ...
                            Padding(
                              padding: const EdgeInsets.all(15.0),
                              child: InkWell(
                                onTap:(){ Navigator.push(context, MaterialPageRoute(builder: (context) =>Teacher_contact(),),);},
                                child: Container(
                         ...
                         Padding(
                          ...
                          children: [ 
                            ...
                            Padding(
                              padding: const EdgeInsets.all(15.0),
                              child: InkWell(
                                onTap:(){ Navigator.push(context, MaterialPageRoute(builder: (context) =>Teacher_Addres(),),);},
                                child: Container(
